#' @title plotRatioDensity Function to plot density of ratios between two treatments (using groupings from an annotation column) within a countData object.
#' @description This function plots the expression of the supplied countData object, using ratios between a pair of selected treatments.
...
#' @details This function plots expression of the supplied countData object using ratios of treatment1/treatment2.

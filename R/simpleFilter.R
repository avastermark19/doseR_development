#' @title simpleFilter Function to filter expression data of a countData object.
...
#' @details This function filters the expression of the supplied countData object, based on a selected cutoff.

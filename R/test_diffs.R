#' @title test_diffs Statistics function to summarize expression data of a countData object, using ratios between selected treatments.
...
#' @details This function completes summary statistics of the expression of the supplied countData object.
#' @return Returns an invisible list of summary statistics, kruskal test and raw data of a countData object, using ratios between selected treatments.

#' @title dafsFilterWrapper	Function to filter expression data within a countData object.
...
dafsFilterWrapper <- function(cD, PLOT=TRUE) {

  #utils::globalVariables(dafsFilter)

  VEC1 <- rowMeans(cD@RPKM)

  cutoff <- dafsFilter (VEC1, PLOT)

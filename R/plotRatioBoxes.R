#' @title plotRatioBoxes Function to boxplot density of ratios between two treatments (using groupings from an annotation column) within a countData object.
#' @description This function plots the expression of the supplied countData object, representing ratios between a pair of selected treatments as a boxplot for each group in the selected annotation column.
...
#' @details This function boxplots expression of the supplied countData object using ratios of treatment1/treatment2.
